...
def get_tickets(
    ...
    if search:
        ...
        query = query.filter(
        (models.Ticket.customer_name.ilike(search)) |
        (models.Ticket.ticket_id.ilike(search)) |
        (models.Ticket.customer_email.ilike(search)) |
        (models.Ticket.description.ilike(search))
        )
